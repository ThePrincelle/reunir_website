        ...
        <div className="max-w-max lg:max-w-7xl mx-auto">
          <div className="relative z-10 mb-8 md:mb-2 md:px-6">
            <div className="text-base max-w-prose lg:max-w-none">
              <h2 className="leading-6 text-green-600 font-semibold tracking-wide uppercase">Présentations</h2>
          ...
          <div className="relative">
            ...
            <div className="relative md:bg-white md:p-6">
              <div className="lg:grid lg:grid-cols-2 lg:gap-6">
                <div className="prose prose-yellow prose-lg text-gray-500 lg:max-w-none" dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(contenu_gauche)}}>
                </div>
                <div className="mt-6 prose prose-yellow prose-lg text-gray-500 lg:mt-0" dangerouslySetInnerHTML={{__html: DOMPurify.sanitize(contenu_droite)}}>
                </div>
              </div>
