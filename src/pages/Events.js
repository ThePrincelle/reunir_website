			...
			{events.length > 0 && (
				<div className="bg-white py-12 md:py-24 lg:py-30">
					<div className="mx-auto grid max-w-7xl grid-cols-1 gap-y-20 gap-x-8 px-6 lg:px-8 xl:grid-cols-3">
						...
						<div className="-mt-6 border-b border-gray-900/ space-y-5">
							{events.map((event) => (
								<div
									key={event._id}
									className={"overflow-hidden bg-gray-50 shadow rounded-lg group transition-all" + (event.pinned ? " border-2 border-yellow-500" : "")}
								>
